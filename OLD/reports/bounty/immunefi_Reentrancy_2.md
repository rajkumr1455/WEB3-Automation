...
The contract is vulnerable to reentrancy in the 'withdraw' function. The external call to msg.sender before updating the state can allow attackers to drain funds repeatedly.
...
- **Discovered**: 2025-11-24 11:42 UTC
- **Verified**: N/A
- **Reported**: 2025-11-24 11:43 UTC

---

*Report generated by Web3 Hunter ML-Enhanced Scanner*  
*Vulnerability ID: 2 | Scan ID: 2*
